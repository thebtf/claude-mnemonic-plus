...
func (s *Service) handleGetConfig(w http.ResponseWriter, _ *http.Request) {
	...
	response := map[string]any{
		...
		"graph": map[string]any{
			...
			"provider":         cfg.GraphProvider,
			"search_expansion": cfg.GraphSearchExpansion,
			"max_hops":         cfg.GraphMaxHops,
			"branch_factor":    cfg.GraphBranchFactor,
			"inject_bfs":       cfg.InjectGraphBFSEnabled,
		},
